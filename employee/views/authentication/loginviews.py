...
from superadmin.models import Employee,Project,Task,Client
...
def employee_login(request):
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            if user is not None:
                ...
                # request.session['employee_image'] = user.img.url if user.img else None
    ...
    return render(request, 'employee/authentication/form.html', {'form': form})
